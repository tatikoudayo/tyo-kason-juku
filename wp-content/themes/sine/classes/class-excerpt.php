...
/**
* Call to Sine__Excerpt
*
* @since  1.0.0
* @uses   Sine__Excerpt:::get_instance()->excerpt()
* @param  int $length
* @return void
*/
if( ! function_exists( 'sine_excerpt' ) ):

    function sine_excerpt( $length = 55, $echo = true, $more = '', $page_id = false ) {
        $length = apply_filters( 'sine_excerpt_length', $length );
        return Sine__Excerpt::get_instance()->excerpt( $length, $echo, $more, $page_id );
    }
endif;