...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Sine_Customizer_Color_Control extends WP_Customize_Control {

		public $type = 'sine-color-picker';
		...
		public function enqueue() {
			wp_enqueue_script( 'wp-sine-color-picker' );
			wp_enqueue_style( 'wp-sine-color-picker' );
		}
...
sine_Customizer::add_custom_control( array(
    ...
    'class'    => 'Sine_Customizer_Color_Control',
    'sanitize' => array( 'Sine_Customizer', 'sanitize_rgba' ),
));