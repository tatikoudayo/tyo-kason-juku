...
class Sine_Customizer_Dimensions_Control extends WP_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['title'] 	= esc_html__( 'Link values together', 'sine' );
	...
	protected function content_template() {
		...
		<ul class="desktop control-wrap active">
	        ...
	        <li class="dimension-wrap">
	            <div class="link-sine-dimensions">
	...
	protected function l10n( $id = false ) {
		$translation_strings = array(
			'desktop_top' 		=> esc_html__( 'Top', 'sine' 	),
			'desktop_right' 	=> esc_html__( 'Right', 'sine' 	),
			'desktop_bottom' 	=> esc_html__( 'Bottom', 'sine' ),
			'desktop_left' 		=> esc_html__( 'Left', 'sine' 	),
			'tablet_top' 		=> esc_html__( 'Top', 'sine' 	),
			'tablet_right' 		=> esc_html__( 'Right', 'sine' 	),
			'tablet_bottom' 	=> esc_html__( 'Bottom', 'sine' ),
			'tablet_left' 		=> esc_html__( 'Left', 'sine' 	),
			'mobile_top' 		=> esc_html__( 'Top', 'sine' 	),
			'mobile_right' 		=> esc_html__( 'Right', 'sine' 	),
			'mobile_bottom' 	=> esc_html__( 'Bottom', 'sine' ),
			'mobile_left' 		=> esc_html__( 'Left', 'sine' 	),
		);
		if ( false === $id ) {
