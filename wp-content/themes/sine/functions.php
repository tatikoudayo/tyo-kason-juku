...
final class Sine_Theme extends Sine_Helper{
	...
	public function __construct(){
		...
		add_action( self::fn_prefix( 'after_header' ), array( __CLASS__ , 'featured_section' ), 20 );
	...
	*/
	...
	public static function register_required_plugins(){
		$plugins = array(
			...
			array(
				'name'     => esc_html__( 'RT Easy Builder – Advanced addons for Elementor', 'sine' ),
