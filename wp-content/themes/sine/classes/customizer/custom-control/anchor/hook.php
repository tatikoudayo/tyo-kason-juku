...
if( !class_exists( 'Sine_Customizer_Anchor_Integration' ) ){
	class Sine_Customizer_Anchor_Integration extends Sine_Customizer{

		public static $type  = 'sine-anchor';
		public static $class = 'Sine_Anchor_Customize_Section';
	...
	new Sine_Customizer_Anchor_Integration();
}