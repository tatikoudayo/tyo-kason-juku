<?php
/** 
 * Customizer Control: sine-category-dropdown
 *
 * @since 1.0.0
...
if ( class_exists( 'WP_Customize_Control' ) ) {
    class Sine_Category_Dropdown extends WP_Customize_Control {
        /**
         ...
         * @var string
         */
        public $type = 'sine-category-dropdown';
        ...
        public function render_content() {
            $dropdown_categories = wp_dropdown_categories(
                array(
                    'name' => $this->id,
                    'show_option_all'  => esc_html__( 'All', 'sine' ),
                    'echo'              => 0,
                    'order'             => 'DESC',
                    'selected'          => $this->value()
                )
