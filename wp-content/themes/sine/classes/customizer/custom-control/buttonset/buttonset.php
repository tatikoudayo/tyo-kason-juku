<?php
/**
 * Customizer Control: sine-buttonset.
 *
 * @since   1.0.0
 *
...
if ( class_exists( 'WP_Customize_Control' ) ){
	class Sine_Customizer_Buttonset_Control extends WP_Customize_Control {
		...
		protected function content_template() {
			...
			<# } #>
			<div id="input_{{ data.id }}" class="sine-buttonset">
...
Sine_Customizer::add_custom_control( array(
    'type'     => 'sine-buttonset',
    'class'    => 'Sine_Customizer_Buttonset_Control',
