 ...
 */
if( !class_exists( 'Sine_Customizer_Slider_Integration' ) ){
	class Sine_Customizer_Slider_Integration extends Sine_Customizer{
		 ...
		 * @package Sine WordPress Theme
		 */
		public static $type = 'sine-slider';

		public static $class = 'Sine_Customizer_Slider_Control';
	...
	new Sine_Customizer_Slider_Integration();
}